...
# run manually:  board/gamestation/doPcsx2package.sh "output/target" "output/pcsx2" "output/images/gamestation"
...
XTARGET_VERSION=$(cat "${G_TARGETDIR}/gamestation/gamestation.version" | sed -e s+" .*$"++)
XTARGET_ARCH=$(cat "${G_TARGETDIR}/gamestation/gamestation.arch")
