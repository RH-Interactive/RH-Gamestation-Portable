...
/gamestation/scripts/gamestation-systems.py > "${DSYSTEM}/bios.txt"
...
f_cp /gamestation/share/system/logs/es_launch_stdout.log         "${DSYSTEM}"
f_cp /gamestation/share/system/logs/es_launch_stderr.log         "${DSYSTEM}"
f_cp /boot/gamestation-boot.conf                                 "${DSYSTEM}"
f_cp /var/log/Xorg.0.log                                      "${DSYSTEM}"

# Emulators configs
d_cp /gamestation/share/system/configs                           "${TMPDIR}/configs"
