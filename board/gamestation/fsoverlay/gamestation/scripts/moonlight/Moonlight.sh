...
#cd /gamestation/share/roms/moonlight/
moonlight_dir=/gamestation/scripts/moonlight
moonlight_config_dir=/gamestation/share/system/configs/moonlight
moonlight_romsdir=/gamestation/share/roms/moonlight
moonlight_ip=
...
scrape () {
  ...
  GAMELIST=/gamestation/share/roms/moonlight/gamelist.xml
  IMGPATH=/gamestation/share/roms/moonlight/downloaded_images
...
case $1 in
    ...
    clean)
        cmd="rm -rf $moonlight_config_dir/keydir && echo 'You can now pair again your gamestation with a PC'" ;;
