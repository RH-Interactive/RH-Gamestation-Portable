...
class FsuaeGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        ...
        commandArray = [gamestationFiles.gamestationBins[system.config['emulator']], "--fullscreen",
                                                                               "--amiga-model="     + system.config['core'],
                                                                               "--base_dir="        + gamestationFiles.fsuaeConfig,
                                                                               "--kickstarts_dir="  + gamestationFiles.fsuaeBios,
                                                                               "--save_states_dir=" + gamestationFiles.fsuaeSaves + "/" + system.config['core'] + "/" + self.filePrefix(rom),
                                                                               "--zoom=auto"
                       ]
