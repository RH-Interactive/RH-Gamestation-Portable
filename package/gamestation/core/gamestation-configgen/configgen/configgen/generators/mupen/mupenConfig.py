...
def setPaths():
	mupenSettings.save('ScreenshotPath', gamestationFiles.SCREENSHOTS)
	mupenSettings.save('SaveStatePath', gamestationFiles.mupenSaves)
	mupenSettings.save('SaveSRAMPath', gamestationFiles.mupenSaves)
