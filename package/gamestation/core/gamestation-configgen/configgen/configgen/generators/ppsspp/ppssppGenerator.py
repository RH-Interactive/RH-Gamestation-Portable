    ...
    def generate(self, system, rom, playersControllers, gameResolution):
        if not 'configfile' in system.config:
            ...
            for index in playersControllers :
                ...
                cfgFile = open(gamestationFiles.ppssppControls, "w")
        ...
        #commandArray = [gamestationFiles.gamestationBins[system.config['emulator']], rom, "--escape-exit"]
        return Command.Command(array=commandArray, env={"XDG_CONFIG_HOME":gamestationFiles.CONF, "SDL_VIDEO_GL_DRIVER": "/usr/lib/libGLESv2.so", "SDL_VIDEO_EGL_DRIVER": "/usr/lib/libGLESv2.so", "PPSSPP_GAME_CONTROLLER_DB_PATH": gamestationFiles.ppssppControls})
