...
import re
import argparse
import configgen.gamestationFiles as gamestationFiles

settingsFile = gamestationFiles.gamestationConf
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='gamestation-config script')
