...
ifeq ($(BR2_PACKAGE_GAMESTATION_TARGET_S905)$(BR2_PACKAGE_GAMESTATION_TARGET_S912)$(BR2_PACKAGE_GAMESTATION_TARGET_C2)$(BR2_PACKAGE_GAMESTATION_TARGET_XU4)$(BR2_PACKAGE_GAMESTATION_TARGET_LEGACYXU4)$(BR2_PACKAGE_GAMESTATION_TARGET_ROCKPRO64),y)
       MUPEN64PLUS_GLIDEN64_CONF_OPTS += -DGLES2=1
endif

define MUPEN64PLUS_GLIDEN64_INSTALL_TARGET_CMDS
	mkdir -p $(TARGET_DIR)/gamestation/configs/mupen64/
	...
	$(INSTALL) -D $(@D)/ini/* \
		$(TARGET_DIR)/gamestation/configs/mupen64/
endef
