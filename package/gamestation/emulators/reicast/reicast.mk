...
define REICAST_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) \
		...
		AS="$(TARGET_CC)" \
		STRIP="$(TARGET_STRIP)" \
		-C $(@D)/shell/linux -f Makefile platform=$(GAMESTATION_SYSTEM) $(REICAST_EXTRA_ARGS)
endef
