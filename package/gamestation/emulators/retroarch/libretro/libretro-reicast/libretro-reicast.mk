...
ifeq ($(BR2_PACKAGE_GAMESTATION_TARGET_RPI2),y)
...
ifeq ($(BR2_PACKAGE_GAMESTATION_TARGET_XU4)$(BR2_PACKAGE_GAMESTATION_TARGET_LEGACYXU4),y)
	LIBRETRO_REICAST_PLATFORM = odroid-ODROID-XU3-gles
endif

ifeq ($(BR2_PACKAGE_GAMESTATION_TARGET_ROCKPRO64),y)
