...
define MALI_RK450_INSTALL_STAGING_CMDS
	...
	cp package/gamestation/gpu/mali-rk450/gbm.pc $(MALI_RK450_STAGING_DIR)/usr/lib/pkgconfig/gbm.pc
	cp package/gamestation/gpu/mali-rk450/egl.pc $(MALI_RK450_STAGING_DIR)/usr/lib/pkgconfig/egl.pc
endef
