...
#gamestation enable nvidia-driver and mesa3d to coexist in the same fs
NVIDIA_DRIVER_DEPENDENCIES = mesa3d xlib_libX11 xlib_libXext libglvnd
# NVIDIA_DRIVER_PROVIDES = libgl libegl libgles

# gamestation modified to suport the vendor-neutral "dispatching" API/ABI
#   https://github.com/aritger/linux-opengl-abi-proposal/blob/master/linux-opengl-abi-proposal.txt
#gamestation generic GL libraries are provided by libglvnd
#gamestation only vendor version are installed
...
# gamestation install 32bit libraries
...
# gamestation nvidia libs are runtime linked via libglvnd
...
# gamestation install files needed by libglvnd
